...
export default class ServiceB extends Component {
  render() {
    return (
      <ServiceWrapper>
        <Head>
        ...
        <div className="xs-12 content">
          <div className="xs-10 xs-off-1 sm-8 sm-off-2">
            <h3>
              Atteignez des niveaux de performance supérieur aux standards
              actuels
            </h3>
            <p>
              ...
              pays de la sous-région Ouest-Africaine. Aujourd’hui plus que
              jamais, il est primordiale d’identifier rapidement les foyers de
              contaminations sur les parcelles afin de trouver des solutions
              adéquates en vue d’optimiser la production, de prévenir les
              attaques et d’éviter des pertes de production.
            </p>
            <p>
            ...
            <div className="xs-12 top">
              ...
              <p>
                ...
                permettant d’identifier rapidement sur votre parcelle les zones
                de maladies, les zones les moins fertiles et les moins
                hydratées, de manière à faire des épandages d’engrais et des
                traitements phytosanitaires beaucoup plus précis, à gérer la
                ressource en eau et à économiser les intrants.
              </p>
              <p>
                Pour ce faire, au cours de l’activité de terrain, on établit
                avec le drone un plan de vol parcellaire dont l’objectif est
                d’extraire le plus de données possible de l’état de la parcelle.
                Ces données sont ensuite traitées par des experts et ingénieurs
                agronome afin d’établir des cartes.
              </p>
            </div>
