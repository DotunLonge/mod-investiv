      ...
      <ServiceWrapper>
        ...
        <div className="xs-12 content">
          <div className="xs-10 xs-off-1 sm-8 sm-off-2">
            ...
            <p>
              Nous mettons à votre disposition des plantations « clé en main »
              sur lesquelles nous vous accompagnons sur un nombre de cycles
              déterminé afin de vous aider à cerner tous les contours d’une
              activité agricole donnée et de prendre votre envol tout seul par
              la suite.
            </p>
